...
class home implements IPage {
    ...
    function showPage(): string {
        ...
        while($row = $rs->fetch_assoc()) {
            ...
            $hkActivities .= "<a href='#' class='btn btn-primary stretched-link btn-rounded'>了解更多</a></div></div></div>";
        }
        ...
        while($row = $rs->fetch_assoc()) {
            ...
            $cnActivities .= "<a href='#' class='btn btn-primary stretched-link btn-rounded'>了解更多</a></div></div></div>";
        }
        ...
        while($row = $rs->fetch_assoc()) {
            ...
            $moActivities .= "<a href='#' class='btn btn-primary stretched-link btn-rounded'>了解更多</a></div></div></div>";
        }
        ...
        while($row = $rs->fetch_assoc()) {
            ...
            $twActivities .= "<a href='#' class='btn btn-primary stretched-link btn-rounded'>了解更多</a></div></div></div>";
        }
        return <<<body

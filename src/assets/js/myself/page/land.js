            ...
            if (data.code === 200){
                ...
                if (data.data.length <= 0){
                    ...
                    map = data.data.map((value) => {
                        ...
                        if (value.rate != null) {
                            if(value.rate < 4) {
                                rate = "<span id='landRatingScore' class='fs-10'>" + value.rate.toString() + "</span><span class='fs-5'>/5.0</span><span class='fs-10'>&nbsp&nbsp&nbsp" + comments +  "</span>";
                            } else {
                                rate = "<span id='landRatingScoreOverEqual4' class='fs-10'>" + value.rate.toString() + "</span><span class='fs-5'>/5.0</span><span class='fs-10'>&nbsp&nbsp&nbsp" + comments +  "</span>";
                            }

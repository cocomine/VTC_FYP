...
<head>
    ...
    <title><?php echo showText("Error_Page.403_title");?></title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="shortcut icon" type="image/png" href="//<?php echo $_SERVER['HTTP_HOST'];?>/panel/assets/images/icon/favicon.png">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-Zenh87qX5JnK2Jl0vWa8Ck2rdkQ2Bzep5IDxbcnCeuOxjzrPF/et3URy9Bv1WTRi" crossorigin="anonymous">    <link rel="stylesheet" href="//<?php echo $_SERVER['HTTP_HOST'];?>/panel/assets/css/default-css.css">
    ...
    <div class="error-area ptb--100 text-center">
        <div class="container">
            <div class="error-content">
                ...
                <p><?php echo showText("Error_Page.Dont_Come");?></p>
